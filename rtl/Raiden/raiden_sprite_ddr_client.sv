...
//
// raiden_sprite_ddr_client.sv
// Wrapper di raiden_ddram che espone un'interfaccia ddr_if.from_host.
// Logica interna IDENTICA a raiden_ddram (cache 8-byte, FSM read/write).
...
module raiden_sprite_ddr_client
(
	input         clk,
