...
//
/*  raiden_sprite_rom_cache.sv — cache 2-way set associative + DDR3 backend.
    Author: Umberto Parisi (rmonic79)

    Sprite ROM vive in DDR3 (port read del raiden_ddram), non piu' in SDRAM.
    ...
    Cache 2-way set associative, 1024 set × 2 way = 2048 entry totali.
      ...
      Tag   = addr[21:12] (10 bit, copre 4MB di sprite ROM space)
*/

module raiden_sprite_rom_cache #(
